...
for iSample = 1:nSample    
    ...
    FB_ROSCOData        = ReadROSCOtextIntoStruct(ROSCOresultFile);
    ...
    Time_FB         = FB_Data.Time;
    RotSpeed_FB     = FB_Data.RotSpeed;
    PtfmPitch_FB    = FB_Data.PtfmPitch;
    TwrBsMyt_FB     = FB_Data.TwrBsMyt;
    
    
    
    
    % Get signals from FBFF Data
    Time_FBFF     	= FBFF_Data.Time;
    RotSpeed_FBFF 	= FBFF_Data.RotSpeed;  
    PtfmPitch_FBFF  = FBFF_Data.PtfmPitch;
    TwrBsMyt_FBFF   = FBFF_Data.TwrBsMyt;

    
    wind = FBFF_Data.Wind1VelX;
...
% ResizeAndSaveFigure(20,12,'IEA15MW_06.pdf')
