...
!-------------------------------------------------------------------------------------------------------------------------------
    ...
    !
    REAL FUNCTION PIControllerFF(error, kp, ki, PitchRate,minValue, maxValue, DT, I0, reset, inst)
    ! PI controller, capabile to accept forward pitch rate with output saturation
        ...
        ELSE
            PTerm = kp*error
            ITerm(inst) = ITermLast(inst) + DT*ki*error +DT*PitchRate
            ITerm(inst) = saturate(ITerm(inst), minValue, maxValue)
            PIControllerFF = saturate(PTerm + ITerm(inst), minValue, maxValue)
...
!-------------------------------------------------------------------------------------------------------------------------------
    ...
    ! Paremeterized Cp(lambda) function for a fixed pitch angle. Circumvents the need of importing a look-up table
        ...
        REAL(8)  :: minvalue = 0.001    ! min value
        REAL(8)  :: maxvalue = 1.0    ! min value
        REAL(8)  :: CPfunction_temp    ! min value
        
        ! Lookup
        CPfunction_temp = exp(-CP(1)/lambda)*(CP(2)/lambda-CP(3))+CP(4)*lambda
        CPfunction = saturate(CPfunction_temp, minvalue, maxvalue)
...
!-------------------------------------------------------------------------------------------------------------------------------
    ...
    ! Debug routine, defines what gets printed to DEBUG.dbg if LoggingLevel = 1
        ...
        CHARACTER(10)                               :: DebugOutStr1,  DebugOutStr2, DebugOutStr3, DebugOutStr4, DebugOutStr5, &
                                                         ...
                                                         DebugOutStr16, DebugOutStr17, DebugOutStr18, DebugOutStr19, DebugOutStr20,DebugOutStr21,&
                                                         DebugOutStr22                                                           
        CHARACTER(10)                               :: DebugOutUni1,  DebugOutUni2, DebugOutUni3, DebugOutUni4, DebugOutUni5, &
                                                         ...
                                                         DebugOutUni16, DebugOutUni17, DebugOutUni18, DebugOutUni19, DebugOutUni20,DebugOutUni21,&
                                                         DebugOutUni22 
        ...
        DebugOutStr19  = 'Pitch_rate';        DebugOutUni19  = '(rad/s)';       DebugOutData(19)  = LocalVar%FF_PitchRate
        DebugOutStr20  = 'REWS';        DebugOutUni20  = '(m/s)';       DebugOutData(20)  = LocalVar%REWS
        DebugOutStr21  = 'REWS_f';        DebugOutUni21  = '(m/s)';       DebugOutData(21)  = LocalVar%REWS_f
        DebugOutStr22  = 'REWS_b';        DebugOutUni22  = '(m/s)';       DebugOutData(22)  = LocalVar%REWS_b
        ...
        DebugOutStrings =   [CHARACTER(10)  :: DebugOutStr1, DebugOutStr2, DebugOutStr3, DebugOutStr4, &
                                                ...
                                                DebugOutStr17, DebugOutStr18,DebugOutStr19,DebugOutStr20,DebugOutStr21,DebugOutStr22]
        DebugOutUnits =     [CHARACTER(10)  :: DebugOutUni1, DebugOutUni2, DebugOutUni3, DebugOutUni4, &
                                                ...
                                                DebugOutUni17, DebugOutUni18,DebugOutUni19,DebugOutUni20,DebugOutUni21,DebugOutUni22]
