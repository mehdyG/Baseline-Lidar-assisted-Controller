...
TYPE, PUBLIC :: ControlParameters
    ...
    INTEGER(IntKi)                :: FlagLAC                      ! Flag of lidar assisted Pitch forward control 1 use 0 not use
...
TYPE, PUBLIC :: LocalVariables
    ...
    ! FG: variables for feed-forward pitch control
    REAL(DbKi)                    :: FF_PitchRate                 ! forward pitch rate 
    REAL(DbKi)                    :: REWS                         ! rotor effective wind from lidar
