...
! Types:
!       ControlParameters: Parameters read from ROSCO.IN 
...
TYPE, PUBLIC :: ControlParameters
    ...
    REAL(8)                             :: VS_MinOMTq                   ! Minimum torque at the beginning of the below-rated region 2, [Nm]
     ...
     INTEGER(4)                          :: FlagLAC                      ! Flag of lidar assisted Pitch forward control 1 use 0 not use
...
TYPE, PUBLIC :: LocalVariables
    ...
    REAL(8)                             :: FF_PitchRate                 ! forward pitch rate 
    REAL(8)                             :: REWS                         ! rotor effective wind from lidar
    REAL(8)                             :: REWS_f                       ! rotor effective wind from lidar LPF filtered
    REAL(8)                             :: REWS_b                       ! rotor effective wind filter and buffered for FF
