...
TYPE, PUBLIC :: LidarVariables
    ...
    INTEGER(4)                          :: NumberOfModularLidars       	! Number of single beam modular lidars [-]
	REAL(8), DIMENSION(:), ALLOCATABLE  :: AngleToCenterline          	! The angles between the single beam of each modular lidar to the center line of its scanning cone [deg]
    INTEGER(4)                          :: NumberOfMeasurements       	! Number of measurements per full scan for wind field reconstruction [-]
    ...
    ! ---------- internal constants ----------
    INTEGER(4)                          :: nBuffer = 100          		! Size of u_est_Buffer: Buffer for wind field reconstruction, should be larger than any possible NumberOfMeasurements[-]
